    ...
    public partial class HeroisBatalhas_Identidade : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentidadsSecreta", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IdentidadsSecreta_Herois_HeroiId",
                        column: x => x.HeroiId,
                        principalTable: "Herois",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdentidadsSecreta_HeroiId",
                table: "IdentidadsSecreta",
                column: "HeroiId",
                unique: true);
        }
